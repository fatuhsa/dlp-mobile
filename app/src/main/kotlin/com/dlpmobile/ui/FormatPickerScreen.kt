...
/**
 * Format picker screen: lists all available formats and lets the user
 * select one before starting the download.
 *
 * @param formats         Full list of available formats
 * @param selectedFormat  Currently highlighted format, or null
 * @param onBack          Navigate back to Home
 * @param onSelect        Called when the user taps a format row
